...
public class MatchPanel : UIBase
{
   ...
   // private Button btnQuitholding;
    ...
    void Start()
    {
        btnMatch = transform.Find("btnMatch").GetComponent<Button>();//创建房间按钮
        imgBg = transform.Find("imgBg").GetComponent<Image>();
        txtDes = transform.Find("txtDes").GetComponent<Text>();//字体框
        btnCancel = transform.Find("btnCancel").GetComponent<Button>();//取消按钮
        btnEnter = transform.Find("btnEnter").GetComponent<Button>();//进入房间按钮
    ...
    private void cancelClick()
    {
        ...
        setObjectsActive(false);
        this.btnEnter.interactable = false;///////改动
