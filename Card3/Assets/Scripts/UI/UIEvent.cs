...
public class UIEvent
{
    ...
    public const int SHOW_HU_CARD = 19;//胡牌
    public const int SHOW_GANG_CARD = 20;//杠牌
    public const int SHOW_PENG_CARD = 21;//碰牌
    ...
    public const int ZHA_DAN = 1111;//炸弹；
    public const int SHUN_ZI = 2222;//顺子；
    public const int LIAN_DUI = 3333;//连队
    public const int FEI_JI = 4444;//飞机
    public const int WANG_ZHA = 5555;//王炸
